...
class MultiSeedEvaluator:
    def __init__(self, seeds=10, episodes=500000, eval_episodes=50000):
        self.seeds = seeds
    ...
    def run_single_experiment(self, deck_type, use_curriculum, seed):
        ...
        if not use_curriculum:
            ...
            cmd.extend(["--max-episodes-per-stage", "100000"])
...
def main():
    ...
    if args.test_run:
        ...
        evaluator = MultiSeedEvaluator(args.seeds, args.episodes, args.eval_episodes)
